...
with open("validation/v010_tampered_stored_state_bundle.json", "r") as f:
    bundle = json.load(f)
...
print("\nVERIDIAN V-010 TAMPERED STORED-STATE REPLAY")
print("=" * 40)
...
print("\nV-010 RESULT: PASSED — STORED-STATE TAMPER DETECTED AND REPLAY FAILED CLOSED")
